...
public class PlayerMovementState : IState
{
    ...
    private void Move()
    {
        ...
        Vector3 movementDirection = stateMachine.ReusableData.MovementInput.Flattened();
        ...
        // 움직일 때 기존 속도를 제거하기 위해 사용
        Vector3 currentPlayerHorizontalVelocity = GetPlayerHorizontalVelocity();

        // ForceMode.VelocityChange: 질량 무시 / 직접적으로 속도 변화
    ...
    // 현재 플레이어의 수평 속도를 가져옵니다
    protected Vector3 GetPlayerHorizontalVelocity()
    {
        // Flattened(): vector의 Y를 0으로 만들어주는 확장 메서드
        Vector3 playerHorizontalVelocity = stateMachine.Player.Rigidbody.velocity.Flattened();
